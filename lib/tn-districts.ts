// Tamil Nadu - 38 Districts and their Development Blocks (Panchayat Unions)

export const TN_DISTRICTS: Record<string, string[]> = {
  "Ariyalur": ["Andimadam", "Ariyalur", "Jayankondam", "Sendurai", "T.Palur", "Thirumanur"],
  "Chengalpattu": ["Acharapakkam", "Chithamur", "Kattankulathur", "Lathur", "Maduranthakam", "St.Thomas Mount", "Thiruporur", "Tirukalukundram"],
  "Chennai": ["Chennai"],
  "Coimbatore": ["Anamalai", "Annur", "Karamadai", "Kinathukadavu", "Madukkarai", "Periyanayakkanpalayam", "Pollachi North", "Pollachi South", "Sarcarsamakulam", "Sultanpet", "Sulur", "Thondamuthur"],
  "Cuddalore": ["Annagramam", "Cuddalore", "Kammapuram", "Kattumannarkoil", "Keerapalayam", "Kumaratchi", "Kurinjipadi", "Mangalore", "MelBhuvanagiri", "Nallur", "Panruti", "Parangipettai", "Virudhachalam"],
  "Dharmapuri": ["Dharmapuri", "Harur", "Karimangalam", "Morappur", "Nallampalli", "Palacode", "Pappireddipatti", "Pennagaram"],
  "Dindigul": ["Athoor", "Batlagundu", "Dindigul", "Guziliamparai", "Kodaikanal", "Natham", "Nilakottai", "Oddanchatram", "Palani", "Reddiarchatram", "Shanarpatti", "Sithayankottai", "Vadamadurai", "Vedasandur"],
  "Erode": ["Ammapet", "Anthiyur", "Bhavani", "Bhavanisagar", "Chennimalai", "Erode", "Gobichettipalayam", "Kodumudi", "Modakkurichi", "Nambiyur", "Perundurai", "Sathyamangalam", "Talavadi", "Thoockanaickenpalaiyam"],
  "Kallakurichi": ["Chinnasalem", "Kallakurichi", "Kalvarayan Hills", "Rishivandiyam", "Sankarapuram", "Thiagadurgam", "Tirukoilur", "Tirunavalur", "Ulundurpet"],
  "Kancheepuram": ["Kancheepuram", "Kundrathur", "Sriperumbudur", "Uthiramerur", "Walajabad"],
  "Kanniyakumari": ["Agastheeswaram", "Killiyoor", "Kurunthencode", "Melpuram", "Munchirai", "Rajakkamangalam", "Thiruvattar", "Thovalai", "Thuckalay"],
  "Karur": ["Aravakurichi", "K.Paramathi", "Kadavur", "Karur", "Krishnarayapuram", "Kulithalai", "Thanthoni", "Thogamalai"],
  "Krishnagiri": ["Bargur", "Hosur", "Kaveripattinam", "Kelamangalam", "Krishnagiri", "Mathur", "Shoolagiri", "Thally", "Uthangarai", "Veppanapalli"],
  "Madurai": ["Alanganallur", "Chellampatti", "Kallikudi", "Kottampatti", "Madurai East", "Madurai West", "Melur", "Sedapatti", "T.Kallupatti", "Thirumangalam", "Thirupparankundram", "Usilampatti", "Vadipatti"],
  "Mayiladuthurai": ["Kollidam", "Kuthalam", "Mayiladuthurai", "Sembanarkoil", "Sirkali"],
  "Nagapattinam": ["Keelaiyur", "Kilvelur", "Nagapattinam", "Thalanayar", "Thirumarugal", "Vedaranyam"],
  "Namakkal": ["Elachipalayam", "Erumapatty", "Kabilarmalai", "Kolli Hills", "Mallasamudram", "Mohanur", "Namagiripet", "Namakkal", "Pallipalayam", "Paramathi", "Puduchatram", "Rasipuram", "Sendamangalam", "Tiruchengode", "Vennandur"],
  "Nilgiris": ["Coonoor", "Gudalur", "Kotagiri", "Udhagamandalam"],
  "Perambalur": ["Alathur", "Perambalur", "Veppanthattai", "Veppur"],
  "Pudukkottai": ["Annavasal", "Aranthangi", "Arimalam", "Avudaiyarkoil", "Gandarvakottai", "Karambakudi", "Kunnandarkoil", "Manamelkudi", "Ponnamaravathi", "Pudukkottai", "Thirumayam", "Thiruvarankulam", "Viralimalai"],
  "Ramanathapuram": ["Bogalur", "Kadaladi", "Kamuthi", "Mandapam", "Mudukulathur", "Nainarkoil", "Paramakudi", "Rajasingamangalam", "Ramanathapuram", "Thiruppullani", "Tiruvadanai"],
  "Ranipet": ["Arakkonam", "Arcot", "Kaveripakkam", "Nemili", "Sholinghur", "Timiri", "Walajah"],
  "Salem": ["Attur", "Ayothiapattinam", "Gangavalli", "Kadayampatti", "Kolathur", "Konganapuram", "Magudanchavadi", "Mecheri", "Nangavalli", "Omalur", "Panamarathupatty", "Peddanaickenpalayam", "Salem", "Sankari", "Thalaivasal", "Tharamangalam", "Valappaddy", "Veerapandy", "Yercaud"],
  ...
  "Tiruchirappalli": ["Andhanallur", "Lalgudi", "Manachanallur", "Manapparai", "Manikandam", "Marungapuri", "Musiri", "Pullambadi", "Srirangam", "Thiruverumbur", "Thottiyam", "Thuraiyur", "Tiruchirappalli", "Uppiliapuram"],
  ...
  "Tiruppur": ["Avinashi", "Dharapuram", "Gudimangalam", "Kangeyam", "Kundadam", "Madathukulam", "Mulanur", "Palladam", "Pongalur", "Tiruppur", "Udumalpet", "Uthukuli", "Vellakoil"],
  "Tiruvallur": ["Ellapuram", "Gummidipoondi", "Kadambattur", "Minjur", "Pallipat", "Ponneri", "Poonamallee", "Puzhal", "RK Pet", "Sholavaram", "Tiruttani", "Tiruvallur", "Uthukkottai", "Villivakkam"],
  "Tiruvannamalai": ["Arani", "Anakkavoor", "Chengam", "Chetpet", "Cheyyar", "Jawadhu Hills", "Kalasapakkam", "Kilpennathur", "Pernamallur", "Polur", "Pudupalayam", "Thandarampattu", "Thellar", "Thurinjapuram", "Tiruvannamalai", "Vandavasi", "Vembakkam", "West Arani"],
  "Tiruvarur": ["Kodavasal", "Koradacheri", "Kottur", "Kudavasal", "Mannargudi", "Muthupettai", "Nannilam", "Needamangalam", "Thiruthuraipoondi", "Tiruvarur", "Valangaiman"],
  "Vellore": ["Anaicut", "Gudiyatham", "K.V.Kuppam", "Kaniyambadi", "Katpadi", "Pernambut", "Vellore"],
  "Viluppuram": ["Gingee", "Kandachipuram", "Koliyanur", "Marakkanam", "Melmalayanur", "Mugaiyur", "Olakkur", "Thiruvennainallur", "Tindivanam", "V.Salai", "Vanur", "Vikravandi", "Viluppuram"],
  "Virudhunagar": ["Aruppukottai", "Kariapatti", "Narikudi", "Rajapalayam", "Sattur", "Sivakasi", "Srivilliputhur", "Tiruchuli", "Vembakottai", "Virudhunagar", "Watrap"],
};

export const DISTRICT_NAMES = Object.keys(TN_DISTRICTS).sort();
