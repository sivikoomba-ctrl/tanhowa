...
export const TN_DISTRICTS: Record<string, string[]> = {
  ...
  "Cuddalore": ["Annagramam", "Cuddalore", "Kammapuram", "Kattumannarkoil", "Keerapalayam", "Kumaratchi", "Kurinjipadi", "Mangalore", "MelBhuvanagiri", "Nallur", "Panruti", "Parangipettai", "Srimushnam", "Virudhachalam"],
  "Dharmapuri": ["Dharmapuri", "Eriyur", "Harur", "Kadathur", "Karimangalam", "Morappur", "Nallampalli", "Palacode", "Pappireddipatti", "Pennagaram"],
  "Dindigul": ["Athoor", "Batlagundu", "Dindigul", "Guziliamparai", "Kodaikanal", "Natham", "Nilakottai", "Oddanchatram", "Palani", "Reddiarchatram", "Shanarpatti", "Thoppampatti", "Vadamadurai", "Vedasandur"],
  ...
  "Salem": ["Attur", "Ayothiapattinam", "Edappadi", "Gangavalli", "Kadayampatti", "Kolathur", "Konganapuram", "Magudanchavadi", "Mecheri", "Nangavalli", "Omalur", "Panamarathupatty", "Peddanaickenpalayam", "Salem", "Sankari", "Thalaivasal", "Tharamangalam", "Valappaddy", "Veerapandy", "Yercaud"],
  ...
  "Tiruvallur": ["Ellapuram", "Gummidipoondi", "Kadambattur", "Minjur", "Pallipat", "Poonamallee", "Poondi", "Puzhal", "RK Pet", "Sholavaram", "Thiruvalangadu", "Tiruttani", "Tiruvallur", "Uthukkottai", "Villivakkam"],
  ...
  "Tiruvarur": ["Koradacheri", "Kottur", "Kudavasal", "Mannargudi", "Muthupettai", "Nannilam", "Needamangalam", "Thiruthuraipoondi", "Tiruvarur", "Valangaiman"],
  "Vellore": ["Anaicut", "Gudiyatham", "K.V.Kuppam", "Kaniyambadi", "Katpadi", "Pernambut", "Vellore"],
  "Viluppuram": ["Gingee", "Kanai", "Kandamangalam", "Koliyanur", "Mailam", "Marakkanam", "Melmalayanur", "Mugaiyur", "Olakkur", "Thiruvennainallur", "Tindivanam", "Vallam", "Vanur", "Vikravandi", "Viluppuram"],
