...
export default function ProfilePage() {
  ...
  const [notifPrefs, setNotifPrefs] = useState({ email: true, telegram: true, in_app: true, weekly_digest: true, whatsapp: false });
        ...
        <CardContent className="pt-5">
          ...
          <div className="space-y-3">
            {[
              ...
              { key: "whatsapp" as const, labelKey: "notif.whatsapp_label" as const, descKey: "notif.whatsapp_desc" as const },
            ].map((item) => (
