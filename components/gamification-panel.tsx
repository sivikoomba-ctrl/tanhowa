...
/**
 * Shared gamification UI (level hero + points breakdown + leaderboard).
 * Used standalone on /dashboard/rewards and embedded in the task area.
 * Pass `showHeading={false}` when embedding under another page heading.
 */
export function GamificationPanel({ showHeading = true }: { showHeading?: boolean }) {
